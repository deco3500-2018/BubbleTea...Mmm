...
<html>
	...
	<body>
		...
		<ons-page id="bg">
			...
			<div style="text-align: center; padding-top:10px; margin: auto;  max-width:80%;" id="textclr">
			...
			<div style="width: 50%; display: block; margin: 0px auto; margin-top: 10px;">
				<ons-button modifier="button large--cta" id='textclr' onclick="location.href='personas.php'">I know what to do</ons-button>
			</div>
			<br>
				...
				<ons-carousel-item>
					<ons-card>
						...
						<div class="content">						
							<section style="margin-top: 10%;">
								<ons-button modifier="large--quiet" style="display: inline-block; width: 48%;" class="left" onclick="prev()">Prev</ons-button>
								<ons-button modifier="large--quiet" style="display: inline-block; width: 48%;" onclick="location.href='personas.php'">Finish</ons-button>
							</section>
						</div>
					</ons-card>
				</ons-carousel-item>
