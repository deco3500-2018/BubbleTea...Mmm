...
<html>
			...
			<ons-carousel class="carousel" auto-scroll id="carousel" auto-refresh swipeable overscrollable>
				...
				<?php
					...
					if( isset($_SESSION['category'])&&isset($_SESSION['interest'])){
						...
						// set the default time zone to Brisbane as the zone time is incorrect
						...
						if (mysqli_num_rows($result) != 0){
							...
							// dynamically generate each card
	...
	<!-- echo the sql statement for testing purposes -->
	<?php
